...
% -------------------------------------------------------------------------
% set path
addpath('Liblinear/windows');        % we use Liblinear package, you need 
...
fea_dir = 'features/Xray';    % directory for saving final image features
